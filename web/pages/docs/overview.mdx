...
- ✅ authentication
- ✅ CLI MVP implementation (basic drop & grab)
- ⬜️ local vaults
- ⬜️ cloud-synced, collaborative vaults
- ⬜️ VS Code Extension
...
The CLI is designed for quick and easy usage and can be leveraged with zero configuration.
