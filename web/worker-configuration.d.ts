/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 48ec755dacf38159c7e2f60c2c73fc8a)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		QSTASH_API_URI: string;
		QSTASH_API_TOKEN: string;
		TEST_URI: string;
		VERCEL_BYPASS_TOKEN: string;
		DEADROP_API_URL: string;
		VITE_DEADROP_API_URL: string;
		VITE_PEER_SERVER_URL: string;
		VITE_HCAPTCHA_SITEKEY: string;
		HCAPTCHA_SECRET: string;
		GOOGLE_ANALYTICS_ID: string;
		GITHUB_APP_CLIENT_ID: string;
		GITHUB_APP_CLIENT_SECRET: string;
		GITHUB_APP_CLIENT_ID_PROD: string;
		GITHUB_APP_CLIENT_SECRET_PROD: string;
		IPINFO_IO_TOKEN: string;
		MAILJET_API_KEY: string;
		MAILJET_API_SECRET: string;
		TWILIO_RECOVER_CODE: string;
		MAILGUN_API_KEY: string;
		VITE_STRIPE_PUBLIC_KEY: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_PRICE_ID: string;
		VITE_STRIPE_LIFETIME_LICENSE_LINK: string;
		STRIPE_WEBHOOK_SECRET: string;
		PRODUCTION_STRIPE_WEBHOOK_SECRET: string;
		VITE_TURN_USERNAME: string;
		VITE_TURN_PWD: string;
		EDGE_CONFIG: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REDIS_URL" | "REDIS_REST_URL" | "REDIS_REST_TOKEN" | "QSTASH_API_URI" | "QSTASH_API_TOKEN" | "TEST_URI" | "VERCEL_BYPASS_TOKEN" | "DEADROP_API_URL" | "VITE_DEADROP_API_URL" | "VITE_PEER_SERVER_URL" | "VITE_HCAPTCHA_SITEKEY" | "HCAPTCHA_SECRET" | "GOOGLE_ANALYTICS_ID" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_CLIENT_SECRET" | "GITHUB_APP_CLIENT_ID_PROD" | "GITHUB_APP_CLIENT_SECRET_PROD" | "IPINFO_IO_TOKEN" | "MAILJET_API_KEY" | "MAILJET_API_SECRET" | "TWILIO_RECOVER_CODE" | "MAILGUN_API_KEY" | "VITE_STRIPE_PUBLIC_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_PRICE_ID" | "VITE_STRIPE_LIFETIME_LICENSE_LINK" | "STRIPE_WEBHOOK_SECRET" | "PRODUCTION_STRIPE_WEBHOOK_SECRET" | "VITE_TURN_USERNAME" | "VITE_TURN_PWD" | "EDGE_CONFIG" | "SENTRY_IGNORE_API_RESOLUTION_ERROR" | "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">> {}
}
